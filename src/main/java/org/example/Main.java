...
public class Main {
    ...
    public static class XMLJTree extends JTree {
        ...
        public void setPath(String filePath) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "No se puede parsear el fichero", "Error",
    ...
    static void setRoom(int index) {
        ...
        comentarios.setText("Bienvenido a la Mazmorra Compadre");
        ...
        for (int i = 0; i < roomList.get(index).getDoorList().size(); i++) {
            switch (roomList.get(index).getDoorList().get(i).getName()) {
                case "Norte" -> north.setVisible(true);
                case "Sur" -> south.setVisible(true);
                case "Este" -> east.setVisible(true);
                case "Oeste" -> west.setVisible(true);
                default ->
                        throw new IllegalStateException("Unexpected value: " + roomList.get(index).getDoorList().get(i).getName());
            }
        }
    }
}
